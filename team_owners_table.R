...
teams_table_fun = function(league_id,season_id = 2014) {
  ...
  # DIVISION
  div_table_html = xpathSApply(body,"//*/table")[[2]]
  ...
  team_vals = teams_table$team_no
  names(team_vals) = teams_table$teams
  return(list(
    team_vals=team_vals,
    teams_table=teams_table,
    div_table_html=div_table_html))
}
